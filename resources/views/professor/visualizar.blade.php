...
<div class="card">
    ...
    <div class="card-body">            
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="nome" name="nome" value="{{ $professor->nome }}" required disabled>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="cpf" name="cpf" value="{{ $professor->cpf }}" required pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" disabled>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="{{ $professor->email }}" required disabled>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="tel" class="form-control" id="telefone" name="telefone" value="{{ $professor->telefone }}" required disabled>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" class="form-control" id="data_nascimento" name="data_nascimento" value="{{ $professor->data_nascimento }}" required disabled>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end mt-4">
                <a href="{{ route('professor.list') }}" class="btn btn-cancel"><i class="bi bi-arrow-return-left"></i> Voltar</a>
                <button type="button" class="btn btn-delete" data-bs-toggle="modal" data-bs-target="#deleteModal" style="background-color: #bb2d3b;"><i class="bi bi-trash"></i> Deletar usuário</button>
            </div>
        </form>
    </div>
</div>
